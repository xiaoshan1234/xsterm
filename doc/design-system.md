...
| `src/components/sidebar/Sidebar.css:439` | `.layout-popover` | Floating panel over sidebar |
| `src/components/WorkspaceBottomBar.css:101` | `.workspace-switcher-item-list` | Floating workspace switcher popover |
