 ...
 * flows — e.g. `splitPane` looks at `canMultiplex` to pick
...
export interface SessionDisplayConfig {
  ...
  timeFormat?: string;
  /** Full datetime format used when lineTimestamp is isEnabled. @default "yyyy-MM-dd HH:mm:ss" */
