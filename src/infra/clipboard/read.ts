...
/**
 * Read plain text from the OS clipboard via the Tauri plugin.
 * Thin wrapper that exists so UI code can avoid a direct
 * `@tauri-apps/plugin-clipboard-manager` import (boundary rule).
 */
